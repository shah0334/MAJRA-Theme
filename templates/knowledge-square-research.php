<?php /* Template Name: Knowledge Square - Research & Studies */ ?>
<?php 
    get_header(); 
    $search_query = '';
    $filter_by_topic = '';
...
<div class="page-heading text-white gap-10 bg-deep-ocean" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/knowledge-square/ks-research-heading.png')">
	...
	<div class="container mb-5">
		<h1 class="head-h2 text-white"><?php echo $language['KNOWLEDGE_SQUARE']['RESEARCH']['CATEGORY'][0]['TITLE']; ?></h1>
    </div>
</div>
        ...
        <div class="row">
            <?php
                $args = array(
                    ...
                    'tax_query' => array(
                        array(
                            'taxonomy' => 'knowledge_square_category', // Replace with your taxonomy if custom
                            'field'    => 'slug',     // Can be 'slug', 'id', or 'name'
                            'terms'    => 'ks-research-studies', // Replace with the desired category slug or ID
                        ),
                    ),
                );
                        ...
                        <div class="project-card shadow-sm">
                            ...
                            <div class="content bg-white p-4 flex-grow-1 d-flex flex-column">
                                <div class="d-flex gap-2 align-items-center mb-3">
                                    <div><h6 class="fw-bold m-0 fs-6"><?php echo $language['KNOWLEDGE_SQUARE']['RESEARCH']['CATEGORY'][0]['TITLE']; ?></h6></div>
                                    <div class="border-top border-3 rounded-pill border-primary" style="width:54px; height:0px"></div>
                                </div>
