...
<main id="primary" class="site-main bg-cp-cream-light py-5">
    <div class="container">
        ...
        <div class="row mb-5">
            ...
            <?php if ( empty($org_profiles) && empty($search) ): ?>
                <!-- No Organization State (Full Block) -->
                <div class="bg-white border rounded-5 shadow-sm p-5 text-center position-relative overflow-hidden" style="border-color: #f3f4f6 !important;">
                    ...
                    <!-- <h2 class="text-start position-absolute top-0 start-0 m-4 font-graphik fw-medium text-cp-deep-ocean fs-5">Registered Organization</h2> -->
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center py-5">
                        ...
                        <h3 class="font-mackay fw-bold text-cp-deep-ocean mb-3 fs-3">No Organization</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <?php else : ?>
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-secondary">No matching organizations found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
